            ...
            <div id="categories-table" class="table-responsive">
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><a data-js="open-edit-cat"><span id="{{ $category->id }}" class="btn btn-warning">Edit</span></a></td>
                        <td><a data-js="open-remove-cat"><span id="{{ $category->id }}" class="btn btn-danger">Remove</span></a></td>
                    </tr>
